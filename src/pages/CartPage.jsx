        ...
        {cart.map((item) => (
          ...
          >
            ...
            <button
              ...
              className="bg-[#d41919] hover:border-2 hover:border-green-700 duration-300 text-white mt-2 p-[8px_24px] rounded md:mt-0 hover:bg-transparent hover:text-black cursor-pointer"
            >
              Delete
            </button>
          </div>
